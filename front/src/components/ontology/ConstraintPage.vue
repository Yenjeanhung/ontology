  ...
  <div class="page-shell">
    <div class="page-head">
      <div class="page-title-row">
        <h2 class="page-title">本体关系</h2>
        <span class="page-subtitle">管理三元组约束：起点本体 + 关系 + 终点本体</span>
      </div>
    </div>
    ...
    <div class="toolbar">
      ...
      <ExcelImportExport scope="constraints" :category-id="selectedCategoryId" @success="loadDetail" />
    </div>
    ...
    <div v-else-if="!selectedCategoryId" class="empty-state">
      ...
      <div class="empty-desc">前往「本体管理」创建类别后即可配置三元组约束</div>
    </div>
