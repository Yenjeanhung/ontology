...
RELATIONS: list[dict] = [
    # 结构类
    {"name": "属于机型", "code": "BELONGS_TO_AC_TYPE", "description": "航空器 → 机型"},
    {"name": "包含系统", "code": "HAS_SYSTEM", "description": "机型 → 系统"},
    {"name": "组成", "code": "PART_OF", "description": "部件 → 系统 / 部件 → 部件"},
    {"name": "装于", "code": "INSTALLED_ON",
     "description": "部件 → 机型（v1 装于机型而非单机，压缩图规模）"},
    {"name": "监测于", "code": "MONITORED_BY", "description": "部件 → 监控参数"},
    {"name": "受控于", "code": "CONTROLLED_BY",
     "description": "部件 → 适航文件（AD/SB 适用性）"},
    # 故障因果类
    {"name": "表现为", "code": "MANIFESTS_AS", "description": "故障原因 → 故障模式"},
    {"name": "征兆为", "code": "HAS_SYMPTOM", "description": "故障原因 → 故障征兆"},
    {"name": "导致", "code": "LEADS_TO",
     "description": "故障原因 → 故障原因；工况 → 故障原因"},
    {"name": "触发于", "code": "TRIGGERED_IN", "description": "故障模式 → 工况"},
    {"name": "上报代码", "code": "REPORTS_CODE", "description": "故障模式 → 故障代码"},
    {"name": "发生于", "code": "OCCURRED_ON",
     "description": "故障模式/原因 → 部件（双树缝合点）"},
    {"name": "归属系统", "code": "IN_SYSTEM", "description": "故障模式/原因 → 系统"},
    # 维修类
    {"name": "适用于", "code": "APPLIES_TO",
     "description": "维修措施 → 故障原因；航材 → 部件"},
    {"name": "需要", "code": "REQUIRES",
     "description": "维修措施 → 航材 / 工装工具"},
    {"name": "互换", "code": "INTERCHANGEABLE_WITH",
     "description": "航材 → 航材（民航互换性）"},
    {"name": "供应自", "code": "SUPPLIED_BY", "description": "部件/航材 → 厂商"},
    {"name": "引用", "code": "REFERENCES", "description": "维修措施 → 手册"},
    {"name": "依据", "code": "PER", "description": "维修措施 → 适航文件"},
    {"name": "覆盖", "code": "COVERS", "description": "手册 → 系统 / 部件"},
    {"name": "对应故障", "code": "MAPS_FAULT", "description": "手册 → 故障代码"},
    {"name": "隔离步骤", "code": "ISOLATION_STEP", "description": "手册 → 维修措施"},
    # 工单与保留类
    {"name": "涉及故障", "code": "INVOLVES_FAULT", "description": "维修工单 → 故障模式"},
    {"name": "采取措施", "code": "TOOK_ACTION", "description": "维修工单 → 维修措施"},
    {"name": "涉及部件", "code": "INVOLVES_COMPONENT", "description": "维修工单 → 部件"},
    {"name": "发生于航空器", "code": "ON_AIRCRAFT", "description": "维修工单 → 航空器"},
    {"name": "处理于", "code": "HANDLED_BY", "description": "维修工单 → 人员"},
    {"name": "执行于", "code": "EXECUTED_AT", "description": "维修工单 → 维修站"},
    {"name": "产生保留", "code": "RAISED_DEFERRAL", "description": "维修工单 → MEL保留"},
    {"name": "依据保留", "code": "PER_DEFERRAL", "description": "MEL保留 → 手册"},
    {"name": "保留涉及", "code": "DEFERRAL_ON", "description": "MEL保留 → 部件"},
    # 图计算产出
    {"name": "相似于", "code": "SIMILAR_TO",
     "description": "图计算产出：故障模式/原因 相似"},
    {"name": "潜在故障", "code": "POTENTIAL_FAULT",
     "description": "图计算产出：部件 → 故障模式（需人工审核）"},
]
